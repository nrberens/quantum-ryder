...
Shader "3y3net/GlowVisible"{
	...
	voutGlow vertPassGlobal(vinGlow v, fixed Occlusion) {
		...
		resizeMatrix[0][0] = 1.0 + (_Outline*Occlusion*_ScaleTrick.r); resizeMatrix[1][1] = 1.0 + (_Outline*Occlusion*_ScaleTrick.g); resizeMatrix[2][2] = 1.0 + (_Outline*Occlusion*_ScaleTrick.b);
